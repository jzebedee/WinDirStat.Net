...
namespace System.IO.Filesystem.Ntfs
{
    public sealed partial class NtfsReader : IDisposable
    {
        ...
        private sealed class StreamWrapper : INtfsStream
        {
            ...
            public IList<INtfsFragment> Fragments
            {
                get
                {
                    ...
                    List<INtfsFragment> newFragments = new List<INtfsFragment>();
        ...
        private sealed class NodeWrapper : INtfsNode
        {
            ...
            public IList<INtfsStream> Streams
            {
                get
                {
                    ...
                    List<INtfsStream> newStreams = new List<INtfsStream>();
        ...
        private sealed class DiskInfoWrapper : INtfsDiskInfo
        {
            ...
            ushort INtfsDiskInfo.BytesPerSector
            {
                get { return BytesPerSector; }
            }

            byte INtfsDiskInfo.SectorsPerCluster
            {
                get { return SectorsPerCluster; }
            }

            ulong INtfsDiskInfo.TotalSectors
            {
                get { return TotalSectors; }
            }

            ulong INtfsDiskInfo.MftStartLcn
            {
                get { return MftStartLcn; }
            }

            ulong INtfsDiskInfo.Mft2StartLcn
            {
                get { return Mft2StartLcn; }
            }

            uint INtfsDiskInfo.ClustersPerMftRecord
            {
                get { return ClustersPerMftRecord; }
            }

            uint INtfsDiskInfo.ClustersPerIndexRecord
            {
                get { return ClustersPerIndexRecord; }
            }

            ulong INtfsDiskInfo.BytesPerMftRecord
            {
                get { return BytesPerMftRecord; }
            }

            ulong INtfsDiskInfo.BytesPerCluster
            {
                get { return BytesPerCluster; }
            }

            ulong INtfsDiskInfo.TotalClusters
            {
